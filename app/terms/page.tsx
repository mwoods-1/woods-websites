      ...
      <section className="py-32">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-24">
          <div className="prose-width space-y-16">
            <p className="text-[var(--text-faint)] text-sm uppercase tracking-wider">
            ...
            <div className="space-y-6">
              <h2
                className="font-display text-2xl md:text-3xl font-black text-[var(--text)] uppercase tracking-tight"
              >
                Overview
              </h2>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-[var(--text-muted)] text-lg leading-relaxed pl-6">
                <li className="relative before:content-[''] before:absolute before:-left-6 before:top-3 before:w-2 before:h-px before:bg-accent">
